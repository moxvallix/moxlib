...
data modify storage moxlib:api/string/resolve output set from entity babd0a7e-aa21-473b-a065-1495066cb515 HandItems[0].components.minecraft:custom_name
