...
execute if score $insert_size moxlib.helpers.inventory.insert <= $stack moxlib.helpers.inventory.insert store result storage moxlib:api/helpers/inventory/insert item.count int 1 run scoreboard players get $insert_size moxlib.helpers.inventory.insert
...
execute store result storage moxlib:api/helpers/inventory/insert item.count int 1 run scoreboard players get $stack moxlib.helpers.inventory.insert
