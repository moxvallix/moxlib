execute store result storage moxlib:helpers/inventory/insert inventory[0].count int 1 run scoreboard players get $target_size moxlib.helpers.inventory.insert
