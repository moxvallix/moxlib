...
function moxlib:data/legacy/paginate/setup

data modify storage moxlib:api/helpers/data/calculate_pages target set from storage moxlib:api/data/legacy/paginate target
data modify storage moxlib:api/helpers/data/calculate_pages count set from storage moxlib:api/data/legacy/paginate count

function moxlib:api/helpers/data/calculate_pages

execute store result score $page moxlib.data.paginate run data get storage moxlib:api/data/legacy/paginate page
execute store result score $count moxlib.data.paginate run data get storage moxlib:api/data/legacy/paginate count
...
function moxlib:data/legacy/paginate/append

function moxlib:data/legacy/paginate/cleanup
