...
data modify storage moxlib:api/data/compare key.components set from storage moxlib:api/helpers/inventory/insert item.components
...
execute store result storage moxlib:helpers/inventory/insert current.count int 1 run scoreboard players get $stack moxlib.helpers.inventory.insert
