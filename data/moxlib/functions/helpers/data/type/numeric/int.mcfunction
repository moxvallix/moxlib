...
execute store result storage moxlib:helpers/data/type compare int 1 run data get storage moxlib:helpers/data/type target
...
execute if data storage moxlib:helpers/data/type {success:false} run data modify storage moxlib:api/helpers/data/type output set value "integer"