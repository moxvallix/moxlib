...
data modify storage moxlib:tui/private border.left append from storage moxlib:tui/page border.top.left
...
data modify storage moxlib:tui/private border.right append from storage moxlib:tui/page border.top.right
